...
import { ADMIN_SIGN_IN } from '../api/apiUrl';
const SignIn = () => {
                    ...
                    <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                        <form className="space-y-6" onSubmit={handleSubmit} method="POST">
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <input id="password" value={formData.password} onChange={handleOnchange} name="password" type={!showPass?'password':'text'} autocomplete="current-password" required className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                                </div>
                            </div>
